...
# # Brier Score # # 
brierScore(probfromLOP, y_orginal_test)

# # Calculate Spieglhalter Z test # # 
Spiegelhalter_z(y_original_test, probfromLOP)

# # Cox intercept & slope # # 
CoxSlope_Intercept = cox_first_degree(y_original, probfromLOP)

# # Hosmer Lemeshow # # 
HL = hosmer_lemeshow(y_original, lrprobpredict, g=20 , "C")

# # log score # # 
logs_binom(y_original, 1, probfromLOP) #size is number of trials of binomial distibution
Log_Score = logs_binom(y_original, 1, probfromLOP)
